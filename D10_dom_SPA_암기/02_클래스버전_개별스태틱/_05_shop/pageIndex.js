...
export class PageIndex {
    ...
    execute(data) {
        ...
        let maxDiscountRateItemList = ItemDAO.getMaxDiscountRateItemList();
        tag +=
        `
            <tr>
                <td>
        ...
        maxDiscountRateItemList = ItemDAO.getMaxItemSoldCountItemLIst();
        tag +=
        `   <tr>`;
    ...
    clickPageItemInfo = (e) => {
        ...
        let index = ItemDAO.getItemIndex(itemNo);

        let data = {index:index};
        ControllerMain.changePage("page-itemInfo", data);
    }
