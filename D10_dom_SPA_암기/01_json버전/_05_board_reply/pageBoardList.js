...
export let PageBoardList = {
    ...
    execute(data) {
        ...
        let boardList = BoardDAO.getBoardSortList();
        ...
        for(let i=0; i<this.$atagBoardInfoPage.length; i++) {
            this.$atagBoardInfoPage[i].addEventListener("click",(e) => { this.boardInfoPageClick(e);});
        }
        ...
        for(let i=0; i<this.$buttonBoardModifyPro.length; i++) {
            this.$buttonBoardModifyPro[i].addEventListener("click",(e) => { this.boardModifyPageClick (e); });
        }
        ...
        for(let i=0; i<this.$buttonBoardDeletePro.length; i++) {
            this.$buttonBoardDeletePro[i].addEventListener("click", (e) => {this.boardDeleteProClick(e);});
        }

        this.$buttonBoardWritePage = document.querySelector("#button-boardWritePage");
        this.$buttonBoardWritePage.addEventListener("click", (e) => {this.boardWritePageClick(e);});

        this.$buttonBoardDummyAddPro = document.querySelector("#button-boardDummyAddPro");
        this.$buttonBoardDummyAddPro.addEventListener("click", (e) => {this.buttonBoardDummyAddProClick(e);});

        this.$checkboxAll = document.querySelector("#checkbox-all");
        this.$checkboxAll.addEventListener("click", (e) => {this.checkboxAllClick(e);});

        this.$checkboxBoard = document.querySelectorAll(".checkbox-board");
        for(let i=0; i<this.$checkboxBoard.length; i++) {
            this.$checkboxBoard[i].addEventListener("click", (e) => {this.checkboxBoardClick(e);});
        }

        this.$buttonCheckBoardDeletePro = document.querySelector("#button-checkBoardDeletePro");
        this.$buttonCheckBoardDeletePro.addEventListener("click", (e) => {this.buttonCheckBoardDeleteProClick(e);});
    },
