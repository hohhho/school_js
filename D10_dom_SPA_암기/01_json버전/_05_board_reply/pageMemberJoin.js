...
export let PageMemberJoin = {
    ...
    execute(data) {
        ...
        this.$inputMemberId.addEventListener("input", (e) => { this.inputMemberIdInput();});

        this.$buttonMemberIdCheckPro = document.querySelector("#button-memberIdCheckPro");
        this.$buttonMemberIdCheckPro.addEventListener("click", (e) => {this.buttonMemberIdCheckProClick();});

        this.$inputMemberPw = document.querySelector("#input-memberPw");
        this.$inputMemberPw.addEventListener("input", (e) => {this.inputMemberPwInput();});

        this.$inputMemberPwRe = document.querySelector("#input-memberPwRe");
        this.$inputMemberPwRe.addEventListener("input", (e) => {this.inputMemberPwReInput();});

        this.$inputMemberName = document.querySelector("#input-memberName");
        this.$inputMemberName.addEventListener("input", (e) => {this.inputMemberNameInput();});

        this.$inputMemberEmail = document.querySelector("#input-memberEmail");
        this.$inputMemberEmail.addEventListener("input",(e) =>{ this.inputMemberEmailInput();});

        this.$buttonMemberEmailCheckPro = document.querySelector("#button-memberEmailCheckPro");
        this.$buttonMemberEmailCheckPro.addEventListener("click", (e) => {this.buttonMemberEmailCheckProClick();});

        this.$inputMemberPhone = document.querySelector("#input-memberPhone");
        this.$inputMemberPhone.addEventListener("input", (e) => {this.inputMemberPhoneInput();});
        ...
        this.$buttonDaumPostAPI.addEventListener("click", (e)=>{ this.execDaumPostcode();});

        this.$checkMemberAllTerms = document.querySelector("#check-memberAllTerms");
        this.$checkMemberAllTerms.addEventListener("click", (e) => {this.checkMemberAllTermsClick();});

        this.$checkMemberTerms = document.querySelectorAll(".check-memberTerms");
        for(let i=0; i<this.$checkMemberTerms.length; i++) {
            this.$checkMemberTerms[i].addEventListener("click", (e) => {this.checkMemberTermsClick();});
        }

        this.$btnMemberJoinPro = document.querySelector("#button-memberJoinPro");
        this.$btnMemberJoinPro.addEventListener("click", (e) => {this.buttonMemberJoinProClick();});
    },
