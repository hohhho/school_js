...
export let PageHeader = {
    execute() {
        ...
        $buttonMemberJoinPage.addEventListener("click", (e) => {this.buttonMemberJoinPageClick();});
        $buttonMemberLoginPage.addEventListener("click", (e) => {this.buttonMemberLoginPageClick();});
